...
from lavis.datasets.datasets.retrieval_datasets import (
    ...
    RetrievalNoriDataset_flan,
    RetrievalEvalNoriDataset
)
...
@registry.register_builder("flickr30k_nori")
class Flickr30kBuilder(BaseDatasetBuilder):
    train_dataset_cls = RetrievalNoriDataset_flan
    eval_dataset_cls = RetrievalEvalNoriDataset
