...
class VisionTransformerEncoder(VisionTransformer, BaseEncoder):
    ...
    @classmethod
    def build(cls, type='base',image_size=224, from_pretrained=False,ckpt_layer=0,drop_path_rate=0,norm_layer_eps=-1,use_grad_checkpointing=False,precision='fp32'):
